...
branchColumnsDef = [
    [field: 'fromBus', datatype: int, description: 'From bus number'],
    [field: 'toBus', datatype: int, description: 'To bus number'],
    [field: 'ckt', datatype: String, description: 'Circuit identifier two character uppercase alphanumeric'],
    [field: 'r', datatype: double, description: 'Branch resistents (pu)'],
    [field: 'x', datatype: double, description: 'Branch reactance (pu)'],
    [field: 'b', datatype: double, description: 'Total branch charging susceptance (pu)'],
    [field: 'ratingA', datatype: double, description: 'First rating (MVA)'],
    [field: 'ratingB', datatype: double, description: 'Second rating (MVA)'],
    [field: 'ratingC', datatype: double, description: 'Third rating (MVA)'],
    [field: 'ratio', datatype: double, description: 'Transformer off nominal turns ratio.'],
    [field: 'angle', datatype: double, description: 'Transformer phase shift angle.'],
    [field: 'shuntG1', datatype: double, description: 'Real portion of complex admittance of the line shunt at the fromBus (pu)'],
    [field: 'shuntB1', datatype: double, description: 'Imaginary portion of complex admittance of the line shunt at the fromBus (pu)'],
    [field: 'shuntG2', datatype: double, description: 'Real portion of complex admittance of the line shunt at the toBus (pu)'],
    [field: 'shuntB2', datatype: double, description: 'Imaginary portion of complex admittance of the line shunt at the toBus (pu)'],
    [field: 'status', datatype: int, description: 'In service status of the branch.'],
]
...
cards = [
    ...
    [name: 'switched_shunts', columns: switchedShuntColumnsDef],
