...
@Component
public class PowergridLauncher {
	...
	class MakeResponse implements GossResponseEvent{
		private final Client client;
		private Gson gson = new Gson();

		public MakeResponse(Client client){
			this.client = client;
		}
	...
	public void start(){
		try {
			...
			client.subscribeTo("/topic/powergrid/create", new MakeResponse(client));
			client.subscribeTo("/topic/powergrid/list", new MakeResponse(client));
